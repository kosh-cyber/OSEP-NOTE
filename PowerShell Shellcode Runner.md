...
[DllImport("kernel32.dll")]public static extern IntPtr **VirtualAlloc**(IntPtr lpAddress, uint dwSize, uint flAllocationType, uint flProtect);[DllImport("kernel32.dll",CharSet=CharSet.Ansi)]public static extern IntPtr **CreateThread**(IntPtr lpThreadAttributes, uint dwStackSize, IntPtr lpStartAddress, IntPtr lpParameter, uint dwCreationFlags, IntPtr lpThreadId);[DllImport("kernel32.dll")]public static extern bool **VirtualProtect**(IntPtr lpAddress, UIntPtr dwSize, uint flNewProtect, out uint lpflOldProtect);
